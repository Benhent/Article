...
import { useArticleStore, useReviewStore, useIssueStore} from "../../../../../store/rootStore"
...
import { ArrowLeft, Download, Edit, Eye, FileText, Trash2 } from "lucide-react"
...
export default function MyArticleDetail() {
  ...
  const { article, fetchArticleById, deleteArticle, loading } = useArticleStore()
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-6">
        <Button variant="ghost" onClick={() => navigate("/post-article")} className="flex items-center">
          <ArrowLeft className="mr-2 h-4 w-4" /> Quay lại danh sách
        </Button>
        <div className="flex gap-2">
          <Button onClick={() => navigate(`/post-article/${article._id}/edit`)}>
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-6">
                ...
                {typeof article.submitterId !== "string" && article.submitterId ? (
                  <div>
                    <div className="font-medium">{article.submitterId.name}</div>
